...
public class VanillaAdvancementDisablerWrapper_v1_17_R1
extends VanillaAdvancementDisablerWrapper {
    ...
    public static void disableVanillaAdvancements(boolean vanillaAdvancements, boolean vanillaRecipeAdvancements) throws Exception {
        ...
        try {
            listener.set(registry, new Advancements.a(){
                ...
                public void b(Advancement advancement) {
                    removed.add(advancement.getName());
                    if (old != null) {
                        old.b(advancement);
                    }
                }
            ...
            Level oldLevel = VanillaAdvancementDisablerWrapper_v1_17_R1.disableLogger();
            try {
                registry.a(locations);
            }
            finally {
                VanillaAdvancementDisablerWrapper_v1_17_R1.enableLogger(oldLevel);
            }
        }
        finally {
        ...
        for (Player player : Bukkit.getOnlinePlayers()) {
            ...
            mcPlayer.b.sendPacket((Packet)removePacket);
        }
    }
