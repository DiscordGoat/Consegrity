...
public class VanillaAdvancementDisablerWrapper_v1_18_R2
extends VanillaAdvancementDisablerWrapper {
    ...
    public static void disableVanillaAdvancements(boolean vanillaAdvancements, boolean vanillaRecipeAdvancements) throws Exception {
        ...
        try {
            ...
            Level oldLevel = VanillaAdvancementDisablerWrapper_v1_18_R2.disableLogger();
            try {
                registry.a(locations);
            }
            finally {
                VanillaAdvancementDisablerWrapper_v1_18_R2.enableLogger(oldLevel);
            }
        }
        finally {
