 ...
 *  net.minecraft.server.v1_16_R2.AdvancementFrameType
...
public class AdvancementDisplayWrapper_v1_16_R2
extends AdvancementDisplayWrapper {
    ...
    public ItemStack getIcon() {
        try {
            net.minecraft.server.v1_16_R2.ItemStack item = (net.minecraft.server.v1_16_R2.ItemStack)iconField.get(this.display);
            return CraftItemStack.asBukkitCopy((net.minecraft.server.v1_16_R2.ItemStack)item);
        }
