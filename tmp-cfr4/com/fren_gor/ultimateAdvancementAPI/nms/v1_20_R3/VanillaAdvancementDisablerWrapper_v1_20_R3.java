...
public class VanillaAdvancementDisablerWrapper_v1_20_R3
extends VanillaAdvancementDisablerWrapper {
    ...
    public static void disableVanillaAdvancements(boolean vanillaAdvancements, boolean vanillaRecipeAdvancements) throws Exception {
        AdvancementDataWorld serverAdvancements = ((CraftServer)Bukkit.getServer()).getServer().aB();
        ...
        try {
            ...
            Level oldLevel = VanillaAdvancementDisablerWrapper_v1_20_R3.disableLogger();
            try {
                tree.a(locations);
            }
            finally {
                VanillaAdvancementDisablerWrapper_v1_20_R3.enableLogger(oldLevel);
            }
        }
        finally {
