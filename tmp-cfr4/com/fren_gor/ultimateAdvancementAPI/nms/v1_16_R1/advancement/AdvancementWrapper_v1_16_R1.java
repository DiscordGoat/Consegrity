 ...
 *  net.minecraft.server.v1_16_R1.AdvancementRewards
...
public class AdvancementWrapper_v1_16_R1
extends AdvancementWrapper {
    ...
    public AdvancementWrapper_v1_16_R1(@NotNull MinecraftKeyWrapper key, @NotNull AdvancementDisplayWrapper display, @Range(from=1L, to=0x7FFFFFFFL) int maxProgression) {
    ...
    public AdvancementWrapper_v1_16_R1(@NotNull MinecraftKeyWrapper key, @NotNull AdvancementWrapper parent, @NotNull AdvancementDisplayWrapper display, @Range(from=1L, to=0x7FFFFFFFL) int maxProgression) {
        Map<String, Criterion> advCriteria = Util.getAdvancementCriteria(maxProgression);
