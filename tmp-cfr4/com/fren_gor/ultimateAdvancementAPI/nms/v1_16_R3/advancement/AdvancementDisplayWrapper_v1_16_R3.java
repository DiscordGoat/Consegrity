...
public class AdvancementDisplayWrapper_v1_16_R3
extends AdvancementDisplayWrapper {
    ...
    public ItemStack getIcon() {
        try {
            net.minecraft.server.v1_16_R3.ItemStack item = (net.minecraft.server.v1_16_R3.ItemStack)iconField.get(this.display);
