...
public class VanillaAdvancementDisablerWrapper_v1_20_R2
extends VanillaAdvancementDisablerWrapper {
    ...
    public static void disableVanillaAdvancements(boolean vanillaAdvancements, boolean vanillaRecipeAdvancements) throws Exception {
        ...
        try {
            ...
            Level oldLevel = VanillaAdvancementDisablerWrapper_v1_20_R2.disableLogger();
            try {
                tree.a(locations);
            }
            finally {
                VanillaAdvancementDisablerWrapper_v1_20_R2.enableLogger(oldLevel);
            }
        }
        finally {
        ...
        for (Player player : Bukkit.getOnlinePlayers()) {
            ...
            AdvancementDataPlayer advs = mcPlayer.O();
