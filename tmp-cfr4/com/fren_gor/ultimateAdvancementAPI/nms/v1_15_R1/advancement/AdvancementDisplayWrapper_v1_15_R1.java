 ...
 *  net.minecraft.server.v1_15_R1.AdvancementFrameType
...
public class AdvancementDisplayWrapper_v1_15_R1
extends AdvancementDisplayWrapper {
    ...
    public AdvancementDisplayWrapper_v1_15_R1(@NotNull org.bukkit.inventory.ItemStack icon, @NotNull String title, @NotNull String description, @NotNull AdvancementFrameTypeWrapper frameType, float x, float y, boolean showToast, boolean announceChat, boolean hidden, @Nullable String backgroundTexture) {
    ...
    public AdvancementDisplayWrapper_v1_15_R1(@NotNull org.bukkit.inventory.ItemStack icon, @NotNull BaseComponent title, @NotNull BaseComponent description, @NotNull AdvancementFrameTypeWrapper frameType, float x, float y, boolean showToast, boolean announceChat, boolean hidden, @Nullable String backgroundTexture) {
        MinecraftKey background = backgroundTexture == null ? null : new MinecraftKey(backgroundTexture);
