...
import com.fren_gor.ultimateAdvancementAPI.nms.v1_20_R3.advancement.AdvancementWrapper_v1_20_R3;
...
public class PreparedAdvancementWrapper_v1_20_R3
extends PreparedAdvancementWrapper {
    ...
    public PreparedAdvancementWrapper_v1_20_R3(@NotNull MinecraftKeyWrapper key, @NotNull AdvancementDisplayWrapper display, @Range(from=1L, to=0x7FFFFFFFL) int maxProgression) {
        this.key = key;
    ...
    public AdvancementWrapper toRootAdvancementWrapper() {
        return new AdvancementWrapper_v1_20_R3(this.key, this.display, this.advCriteria, this.advRequirements);
    }

    @Override
    @NotNull
    public AdvancementWrapper toBaseAdvancementWrapper(@NotNull AdvancementWrapper parent) {
        return new AdvancementWrapper_v1_20_R3(this.key, parent, this.display, this.advCriteria, this.advRequirements);
    }
}
