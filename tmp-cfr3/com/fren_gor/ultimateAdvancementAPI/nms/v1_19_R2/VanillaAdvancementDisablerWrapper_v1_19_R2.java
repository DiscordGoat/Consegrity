...
public class VanillaAdvancementDisablerWrapper_v1_19_R2
extends VanillaAdvancementDisablerWrapper {
    ...
    public static void disableVanillaAdvancements(boolean vanillaAdvancements, boolean vanillaRecipeAdvancements) throws Exception {
        AdvancementDataWorld serverAdvancements = ((CraftServer)Bukkit.getServer()).getServer().ay();
        ...
        try {
            ...
            Level oldLevel = VanillaAdvancementDisablerWrapper_v1_19_R2.disableLogger();
            try {
                registry.a(locations);
            }
            finally {
                VanillaAdvancementDisablerWrapper_v1_19_R2.enableLogger(oldLevel);
            }
        }
        finally {
        ...
        for (Player player : Bukkit.getOnlinePlayers()) {
            ...
            AdvancementDataPlayer advs = mcPlayer.N();
