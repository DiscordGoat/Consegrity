 ...
 *  org.bukkit.craftbukkit.v1_21_R5.util.CraftChatMessage
...
public class AdvancementDisplayWrapper_v1_21_R5
extends AdvancementDisplayWrapper {
    ...
    public AdvancementDisplayWrapper_v1_21_R5(@NotNull ItemStack icon, @NotNull String title, @NotNull String description, @NotNull AdvancementFrameTypeWrapper frameType, float x, float y, boolean showToast, boolean announceChat, boolean hidden, @Nullable String backgroundTexture) {
        ...
        this.display = new AdvancementDisplay(CraftItemStack.asNMSCopy((ItemStack)icon), Util.fromString(title), Util.fromString(description), Optional.ofNullable(clientAsset), (AdvancementFrameType)frameType.toNMS(), showToast, announceChat, hidden);
        this.display.a(x, y);
    ...
    public AdvancementDisplayWrapper_v1_21_R5(@NotNull ItemStack icon, @NotNull BaseComponent title, @NotNull BaseComponent description, @NotNull AdvancementFrameTypeWrapper frameType, float x, float y, boolean showToast, boolean announceChat, boolean hidden, @Nullable String backgroundTexture) {
        ClientAsset clientAsset = Util.parseBackgroundTexture(backgroundTexture);
        this.display = new AdvancementDisplay(CraftItemStack.asNMSCopy((ItemStack)icon), Util.fromComponent(title), Util.fromComponent(description), Optional.ofNullable(clientAsset), (AdvancementFrameType)frameType.toNMS(), showToast, announceChat, hidden);
        this.display.a(x, y);
        this.frameType = frameType;
    }
