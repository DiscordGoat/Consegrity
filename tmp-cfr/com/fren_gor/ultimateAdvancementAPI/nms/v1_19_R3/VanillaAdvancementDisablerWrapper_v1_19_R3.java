...
public class VanillaAdvancementDisablerWrapper_v1_19_R3
extends VanillaAdvancementDisablerWrapper {
    ...
    public static void disableVanillaAdvancements(boolean vanillaAdvancements, boolean vanillaRecipeAdvancements) throws Exception {
        ...
        try {
            ...
            Level oldLevel = VanillaAdvancementDisablerWrapper_v1_19_R3.disableLogger();
            try {
                registry.a(locations);
            }
            finally {
                VanillaAdvancementDisablerWrapper_v1_19_R3.enableLogger(oldLevel);
            }
        }
        finally {
