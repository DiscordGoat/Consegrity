...
public class VanillaAdvancementDisablerWrapper_v1_19_R1
extends VanillaAdvancementDisablerWrapper {
    ...
    public static void disableVanillaAdvancements(boolean vanillaAdvancements, boolean vanillaRecipeAdvancements) throws Exception {
        ...
        try {
            ...
            Level oldLevel = VanillaAdvancementDisablerWrapper_v1_19_R1.disableLogger();
            try {
                registry.a(locations);
            }
            finally {
                VanillaAdvancementDisablerWrapper_v1_19_R1.enableLogger(oldLevel);
            }
        }
        finally {
