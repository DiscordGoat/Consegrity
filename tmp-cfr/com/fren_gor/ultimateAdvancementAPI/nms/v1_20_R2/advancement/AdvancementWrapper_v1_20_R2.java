...
public class AdvancementWrapper_v1_20_R2
extends AdvancementWrapper {
    ...
    public AdvancementWrapper_v1_20_R2(@NotNull MinecraftKeyWrapper key, @NotNull AdvancementDisplayWrapper display, @Range(from=1L, to=0x7FFFFFFFL) int maxProgression) {
        Map<String, Criterion<?>> advCriteria = Util.getAdvancementCriteria(maxProgression);
        Advancement advancement = new Advancement(Optional.empty(), Optional.of((AdvancementDisplay)display.toNMS()), AdvancementRewards.a, advCriteria, Util.getAdvancementRequirements(advCriteria), false, Optional.empty());
    ...
    public AdvancementWrapper_v1_20_R2(@NotNull MinecraftKeyWrapper key, @NotNull AdvancementWrapper parent, @NotNull AdvancementDisplayWrapper display, @Range(from=1L, to=0x7FFFFFFFL) int maxProgression) {
        Map<String, Criterion<?>> advCriteria = Util.getAdvancementCriteria(maxProgression);
        Advancement advancement = new Advancement(Optional.of((MinecraftKey)parent.getKey().toNMS()), Optional.of((AdvancementDisplay)display.toNMS()), AdvancementRewards.a, advCriteria, Util.getAdvancementRequirements(advCriteria), false, Optional.empty());
        this.advancementHolder = new AdvancementHolder((MinecraftKey)key.toNMS(), advancement);
        this.key = key;
        this.parent = parent;
        this.display = display;
    ...
    protected AdvancementWrapper_v1_20_R2(@NotNull MinecraftKeyWrapper key, @NotNull AdvancementDisplayWrapper display, @NotNull Map<String, Criterion<?>> advCriteria, @NotNull AdvancementRequirements advRequirements) {
        Advancement advancement = new Advancement(Optional.empty(), Optional.of((AdvancementDisplay)display.toNMS()), AdvancementRewards.a, advCriteria, advRequirements, false, Optional.empty());
        this.advancementHolder = new AdvancementHolder((MinecraftKey)key.toNMS(), advancement);
        this.key = key;
        this.parent = null;
        this.display = display;
    ...
    protected AdvancementWrapper_v1_20_R2(@NotNull MinecraftKeyWrapper key, @NotNull AdvancementWrapper parent, @NotNull AdvancementDisplayWrapper display, @NotNull Map<String, Criterion<?>> advCriteria, @NotNull AdvancementRequirements advRequirements) {
        Advancement advancement = new Advancement(Optional.of((MinecraftKey)parent.getKey().toNMS()), Optional.of((AdvancementDisplay)display.toNMS()), AdvancementRewards.a, advCriteria, advRequirements, false, Optional.empty());
        this.advancementHolder = new AdvancementHolder((MinecraftKey)key.toNMS(), advancement);
        this.key = key;
        this.parent = parent;
        this.display = display;
    ...
    public @Range(from=1L, to=0x7FFFFFFFL) int getMaxProgression() {
        return this.advancementHolder.b().g().a();
    }
