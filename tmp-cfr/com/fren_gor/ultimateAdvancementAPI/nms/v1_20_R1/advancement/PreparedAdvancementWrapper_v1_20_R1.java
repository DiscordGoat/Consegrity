...
import com.fren_gor.ultimateAdvancementAPI.nms.v1_20_R1.advancement.AdvancementWrapper_v1_20_R1;
...
public class PreparedAdvancementWrapper_v1_20_R1
extends PreparedAdvancementWrapper {
    ...
    public PreparedAdvancementWrapper_v1_20_R1(@NotNull MinecraftKeyWrapper key, @NotNull AdvancementDisplayWrapper display, @Range(from=1L, to=0x7FFFFFFFL) int maxProgression) {
        this.key = key;
    ...
    public AdvancementWrapper toRootAdvancementWrapper() {
        return new AdvancementWrapper_v1_20_R1(this.key, this.display, this.advCriteria, this.advRequirements);
    }

    @Override
    @NotNull
    public AdvancementWrapper toBaseAdvancementWrapper(@NotNull AdvancementWrapper parent) {
        return new AdvancementWrapper_v1_20_R1(this.key, parent, this.display, this.advCriteria, this.advRequirements);
    }
}
