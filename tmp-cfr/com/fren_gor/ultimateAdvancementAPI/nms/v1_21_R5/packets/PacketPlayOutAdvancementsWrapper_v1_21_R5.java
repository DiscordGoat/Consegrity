...
public class PacketPlayOutAdvancementsWrapper_v1_21_R5
extends PacketPlayOutAdvancementsWrapper {
    ...
    public PacketPlayOutAdvancementsWrapper_v1_21_R5() {
        this.packet = new PacketPlayOutAdvancements(true, Collections.emptyList(), Collections.emptySet(), Collections.emptyMap(), true);
    }
    ...
    public PacketPlayOutAdvancementsWrapper_v1_21_R5(@NotNull Map<AdvancementWrapper, Integer> toSend) {
        ...
        for (Map.Entry<AdvancementWrapper, Integer> e : toSend.entrySet()) {
            ...
            map.put((MinecraftKey)adv.getKey().toNMS(), Util.getAdvancementProgress((AdvancementHolder)adv.toNMS(), e.getValue()));
        }
        this.packet = new PacketPlayOutAdvancements(false, ListSet.fromWrapperSet(toSend.keySet()), Collections.emptySet(), (Map)map, true);
    }

    public PacketPlayOutAdvancementsWrapper_v1_21_R5(@NotNull Set<MinecraftKeyWrapper> toRemove) {
        this.packet = new PacketPlayOutAdvancements(false, Collections.emptyList(), ListSet.fromWrapperSet(toRemove), Collections.emptyMap(), true);
    }
