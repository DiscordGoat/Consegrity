...
public class VanillaAdvancementDisablerWrapper_v1_21_R5
extends VanillaAdvancementDisablerWrapper {
    ...
    public static void disableVanillaAdvancements(boolean vanillaAdvancements, boolean vanillaRecipeAdvancements) throws Exception {
        ...
        try {
            ...
            Level oldLevel = VanillaAdvancementDisablerWrapper_v1_21_R5.disableLogger();
            try {
                tree.a(locations);
            }
            finally {
                VanillaAdvancementDisablerWrapper_v1_21_R5.enableLogger(oldLevel);
            }
        }
        finally {
        ...
        for (Player player : Bukkit.getOnlinePlayers()) {
            ...
            AdvancementDataPlayer advs = mcPlayer.S();
            advs.a(serverAdvancements);
            firstPacket.setBoolean(advs, false);
            mcPlayer.g.b((Packet)removePacket);
        }
    }
